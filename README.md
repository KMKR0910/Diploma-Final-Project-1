# 🏥 MedCentre Management System

> A desktop-based Medical Centre Management System developed to automate and improve the efficiency of hospital operations — patients, labs, pharmacy, billing, and more.

![Platform](https://img.shields.io/badge/Platform-Windows%20Desktop-0078D4?style=flat-square&logo=windows)
...
This system is designed for **internal medical centre staff** including doctors, lab assistants, pharmacists, and administrators. It replaces fragmented manual processes with a centralized digital solution to improve accuracy, speed, and data management across the clinic.
